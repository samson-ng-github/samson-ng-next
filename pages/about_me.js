...
export default function about_me({ originalProjects }) {
  return (
    <div className="page">
      <Aside originalProjects={originalProjects} />
      <div className={styles.container} style={{ width: "750px" }}>
        <img
        ...
        <p className={styles.p}>
          ...
          diverse environment and have now lived in the English capital for more
          than twenty years. My logo is an emblem of my three distinct cultural
